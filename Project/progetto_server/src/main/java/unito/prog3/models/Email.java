...
public class Email implements Serializable {
  ...
  public Email(int id, String from, List<String> to, String subject, String body, Date date, boolean isReaded) {
    this.id = id;
    this.from = from;
    this.to = to;
  ...
  public String toString() {
    ...
    sb.append("Email{")
            ...
            .append(", isReaded=").append(isReaded)
  ...
  public static @NotNull Email replaySet(Email toReplay, String username){
    Email email = new Email();
    email.setReplyTo(toReplay);
    email.setSubject(toReplay.getSubject());
    //email.setBody(toReplay.getBody());
  ...
  public static @NotNull Email createReply(Email toReplay, String username){
    Email email = replaySet(toReplay, username);
